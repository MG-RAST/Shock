...
var validParams = []string{"action", "all", "archive_format", "attributes_str", "copy_data", "copy_indexes", "compression", "delete", "expiration", "file_name", "format", "ids", "index_name", "linkage", "operation", "owner", "parent_index", "parent_node", "parts", "path", "preserve_acls", "read", "source", "tags", "type", "unpack_node", "users", "write"}
