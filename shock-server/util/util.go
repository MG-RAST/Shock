...
var validParams = []string{"action", "all", "attributes_str", "copy_data", "copy_index", "delete", "file_name", "format", "ids", "index_name", "linkage", "operation", "owner", "parent_index", "parent_node", "parts", "path", "read", "source", "tags", "type", "users", "write"}
