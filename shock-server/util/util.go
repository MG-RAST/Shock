...
var validParams = []string{"action", "all", "copy_data", "copy_index", "delete", "format", "ids", "index_name", "linkage", "operation", "owner", "parent_index", "parts", "path", "read", "source", "tags", "type", "users", "write"}
